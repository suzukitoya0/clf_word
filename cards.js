...
const allCards = [
  ...
  },
  {
    page: 1,
    term: "クラウドの6つのメリット",
    answer: "①固定費が変動費に変わる　②スケールメリットによる大きなコスト削減　③キャパシティ予測が不要になる　④速度と俊敏性の向上　⑤データセンターの運用・保守への支出が不要　⑥わずか数分で世界中にデプロイ",
    section: "1. クラウドコンピューティングの基礎知識",
    tip: ""
  },
  {
  ...
  },
  {
    ...
    section: "2. コンピューティング関連",
    tip: "補足: ELBと組み合わせて「負荷分散＋自動スケーリング」がAWSの定番構成。Auto Scaling＝台数の増減、ELB＝トラフィックの振り分け、と役割が違う。"
  },
  {
    page: 3,
    term: "Amazon S3",
  ...
  },
  {
    ...
    section: "4. データベース関連",
    tip: "違い①: RDS／Aurora＝表形式（SQL）／DynamoDB・Keyspaces＝キーバリュー・NoSQL／DocumentDB＝JSON文書／Neptune＝グラフ（関係性）／Timestream＝時系列／QLDB＝改ざん不可な台帳／違い②: RDS＝複数DBエンジンに対応した「汎用」マネージドDB／Aurora＝AWS独自の「高性能版」（MySQL・PostgreSQL互換のみ）"
  },
  {
    page: 5,
    term: "Amazon Aurora",
  ...
  },
  {
    ...
    section: "4. データベース関連",
    tip: "違い①: RDS／Aurora＝表形式（SQL）／DynamoDB・Keyspaces＝キーバリュー・NoSQL／DocumentDB＝JSON文書／Neptune＝グラフ（関係性）／Timestream＝時系列／QLDB＝改ざん不可な台帳"
  },
  {
    page: 5,
    ...
    section: "4. データベース関連",
    tip: "違い③: ElastiCache＝DBの手前に置く「キャッシュ」（データ消失を許容）／MemoryDB for Redis＝それ自体が「本番用DB」として使える高耐久インメモリDB／違い④: ElastiCache／MemoryDB＝高速な「インメモリ」処理向け／Redshift＝大量データを分析する「データウェアハウス」"
  },
  {
    page: 5,
  ...
  },
  {
    ...
    section: "4. データベース関連",
    tip: "違い④: ElastiCache／MemoryDB＝高速な「インメモリ」処理向け／Redshift＝大量データを分析する「データウェアハウス」"
  },
  {
    page: 5,
  ...
  },
  {
    ...
    section: "5. ネットワーキング関連",
    tip: "違い③: CloudFront＝コンテンツを「配信」（キャッシュで高速化）／Global Accelerator＝ユーザーを最適な「入口」へ振り分け"
  },
  {
    page: 6,
    ...
    section: "5. ネットワーキング関連",
    tip: "違い①: Direct Connect＝専用線（安定・高速だが構築に時間とコスト）／VPN＝インターネット経由の暗号化接続（すぐ使えるが速度は回線依存）"
  },
  {
    page: 6,
  ...
  },
  {
    ...
    section: "5. ネットワーキング関連",
    tip: "違い②: VPCピアリング＝1対1のVPC接続／Transit Gateway＝多数のVPC・拠点をハブでまとめて接続"
  },
  {
    page: 6,
  ...
  },
  {
    ...
    section: "6. セキュリティ・アイデンティティ関連",
    tip: "違い①: KMS＝暗号化「鍵」の管理／Secrets Manager＝パスワード等の「機密情報そのもの」の管理"
  },
  {
    page: 7,
  ...
  },
  {
    ...
    section: "6. セキュリティ・アイデンティティ関連",
    tip: "違い③: WAF＝Webアプリへの「攻撃」を防ぐ（アプリ層）／Shield＝「DDoS」から守る（ネットワーク層）"
  },
  {
    page: 7,
    term: "AWS Shield",
  ...
  },
  {
    ...
    tip: "違い①: CloudWatch＝リソース単体の「状態」を監視／X-Ray＝サービスを跨いだ「リクエストの流れ」を追跡／CloudTrail（前章）＝「操作」を記録／Config（前章）＝「設定変化」を記録"
  },
  {
    page: 9,
    term: "AWS X-Ray",
  ...
  },
  {
    ...
    section: "9. 移行関連",
    tip: "違い②: MGN＝サーバー全体の「リフト＆シフト」移行／DMS＝「データベースの中身」の移行／SCT＝DB移行時の「スキーマ変換」（DMSの前段）"
  },
  {
    page: 11,
  ...
  },
  {
    ...
    section: "11. 分析関連",
    tip: "違違い②: Kinesis Data Streams＝AWSネイティブなストリーミング基盤／MSK＝使い慣れたApache Kafkaをそのままマネージドで使いたい場合の選択肢（Kafka自体はAWS製ではなくオープンソースの技術本体）"
  },
  {
    page: 12,
    ...
    section: "11. 分析関連",
    tip: "違い②: Kinesis Data Streams＝AWSネイティブなストリーミング基盤／MSK＝使い慣れたApache Kafkaをそのままマネージドで使いたい場合の選択肢（Kafka自体はAWS製ではなくオープンソースの技術本体）"
  },
  {
    page: 12,
    term: "Apache Kafka",
  ...
  },
  {
    ...
    answer: "S3上にデータレイク(生データのまま一時的に保存)構築し、アクセス権限を一元管理するサービス。",
    section: "11. 分析関連",
  ...
  },
  {
    ...
    section: "15. コスト管理・請求関連",
    tip: "違い①: オンデマンド＝自由（一番高い）／RI・Savings Plans＝長期利用の「予約割引」／スポット＝「安いが中断あり」／Dedicated Host＝物理サーバー「丸ごと専有」"
  },
  {
    page: 14,
    term: "リザーブドインスタンス (RI)",
  ...
  },
  {
    ...
    section: "15. コスト管理・請求関連",
    tip: "違い①: オンデマンド＝自由（一番高い）／RI・Savings Plans＝長期利用の「予約割引」／スポット＝「安いが中断あり」／Dedicated Host＝物理サーバー「丸ごと専有」／違い③: Compute Savings Plans＝EC2・Fargate・Lambda等を横断できる最も柔軟な契約／EC2 Instance Savings Plans＝特定インスタンスファミリーに絞る代わりに割引率が高い契約"
  },
  {
    page: 14,
  ...
  },
  {
    ...
    tip: "違い①: リージョン＝広いエリア（国・地域単位）／AZ＝リージョン内の独立した「データセンター群」（障害分離の単位）／エッジロケーション＝ユーザーの近くでコンテンツを配信するための「最前線の拠点」"
  },
  {
    page: 17,
  ...
  },
  {
    ...
    section: "19. 重要な基礎コンセプト",
    tip: "違い②: Local Zones＝特定の大都市圏に置く「リージョンの拡張」（一般的な低レイテンシ用途）／Wavelength＝通信キャリアの5G網の「内部」に置く拠点（モバイル・IoT向けの超低レイテンシ用途）"
  },
  {
    page: 17,
    term: "AWS Wavelength",
  ...
  {
    page: 17,
    term: "Well-Architected Framework 運用上の優秀性",
  ...
  {
    page: 17,
    term: "Well-Architected Framework セキュリティ",
  ...
  {
    page: 17,
    term: "Well-Architected Framework 信頼性",
  ...
  {
    page: 17,
    term: "Well-Architected Framework パフォーマンス効率",
  ...
  {
    page: 17,
    term: "Well-Architected Framework コスト最適化",
  ...
  {
    page: 17,
    term: "Well-Architected Framework 持続可能性",
  ...
  {
    page: 18,
    term: "移行戦略6つのR Repurchase（リパーチェス）",
